      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <div className="text-gray-600 dark:text-gray-300 space-y-2">
            ...
            <p>{data.basics.email} • {data.basics.phone}</p>
          ...
          <div className="space-y-6">
            {data.education.map((edu) => (
              ...
              >
                ...
                {edu.relevantCourses && (
                  <div>
                    <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Relevant Courses:</h4>
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-white flex items-center">
                    ...
                    <a
                      ...
                      onClick={(e) => {
                        if (!project.github) {
                          e.preventDefault();
                          alert("Please add your GitHub link in the project editor");
                        }
                      }}
                    >
        ...
        >
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
            <ul className="list-disc list-inside space-y-2">
              <li className="text-gray-700 dark:text-gray-300">NJIT Information & Cybersecurity Club</li>
              <li className="text-gray-700 dark:text-gray-300">Sigma Alpha Epsilon Fraternity President</li>
            </ul>
          </div>
        </motion.section>
